...
class CurveOidMapper
{
    ...
    const BRAINPOOL_P192R1_OID = '1.3.36.3.3.2.8.1.1.3';
    const BRAINPOOL_P224R1_OID = '1.3.36.3.3.2.8.1.1.5';
    const BRAINPOOL_P256R1_OID = '1.3.36.3.3.2.8.1.1.7';
    const BRAINPOOL_P330R1_OID = '1.3.36.3.3.2.8.1.1.9';
    const BRAINPOOL_P384R1_OID = '1.3.36.3.3.2.8.1.1.11';
    const BRAINPOOL_P512R1_OID = '1.3.36.3.3.2.8.1.1.13';
    ...
    private static $oidMap = array(
        ...
        BrainpoolCurve::NAME_P192R1 => self::BRAINPOOL_P192R1_OID,
        BrainpoolCurve::NAME_P256R1 => self::BRAINPOOL_P256R1_OID,
        BrainpoolCurve::NAME_P330R1 => self::BRAINPOOL_P330R1_OID,
    ...
    private static $sizeMap = array(
        ...
        BrainpoolCurve::NAME_P160R1 => 20,
        BrainpoolCurve::NAME_P192R1 => 24,
        BrainpoolCurve::NAME_P256R1 => 32,
        BrainpoolCurve::NAME_P330R1 => 42,
        BrainpoolCurve::NAME_P384R1 => 44,
        BrainpoolCurve::NAME_P512R1 => 64,
